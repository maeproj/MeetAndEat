...
class UserRegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text = 'Hasło musi zawierać: <ol><li>Co najmniej 8 znaków</li><li>Co najmniej jedną wielką literę</li><li>Co najmniej jedną cyfrę</li>\
        <li>Co najmniej jeden znak specjalny: ./$/#/@/!/&</li></ol>'
