...
urlpatterns = [
    ...
    path('rezerwacje2/', reservation_views.rezerwacje_dodaj_zamowienie, name='reservation2'),
    path('rezerwacje2/edycja_dania', reservation_views.edycja_dania, name='reservation2_edit'),
